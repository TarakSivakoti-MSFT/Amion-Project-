    ...
    **/
    ...
    var draw = function ($picker, option, year, month, day, hour, min) {
        ...
        if ((!isFutureOnly || !isCurrentMonth) && ((minDate == null) || (minDate <
            ...
            $link_before_month.prop('class', "datePickerGlyphicon before-month");
        ...
        var $now_month = $('<span>');
        var $test = $('<div/>');
        $test.prop('class', "monthNav");
        //commented 
        //$now_month.text(date.getFullYear() + " " + translate(locale, 'sep') + " " +
        //    translate(locale, 'months')[date.getMonth()]);

        $now_month.text(translate(locale, 'months')[date.getMonth()] + " " + date.getFullYear());
        ...
        if ((maxDate == null) || (maxDate > cDate.getTime())) {
            ...
            $link_next_month.prop('class', " datePickerGlyphicon next-month");
       ...
       /* if (isTodayButton) {
        ...
        if ($link_before_month != null) {
            $test.append($link_before_month);
        }
        $header.append($now_month);
        if ($link_next_month != null) {
            $test.append($link_next_month);
        }
$header.append($test);
        /* Calendar > Table ----- */
